...
class RegistrationRecordControllerIntegrationSpec extends IntegrationSpec {
    ...
    void "test createRegistrationRecord ok nodemcu"() {
        ...
        controller.response.json == JSON.parse("{\"id\": $registrationRecord.id, \"userId\": $user.id,\"userUsername\": \"$user.username\", \"entryTime\": \"$entryTimeParsed\", \"departureTime\":null, \"timeInSystem\": null}")
        cleanup:
        User.deleteAll(User.list())
    ...
    void "test modifyRegistrationRecord ok nodemcu"() {
        ...
        controller.response.json == JSON.parse("{\"id\": $registrationRecord.id, \"userId\": $user.id,\"userUsername\": \"$user.username\", \"entryTime\": \"$entryTimeParsed\", \"departureTime\":\"$departureTimeParsed\", \"timeInSystem\": \"00:00:0$savedRegistrationRecord.secondsInSystem\"}")
        User.count() == 1
        RegistrationRecord.count() == 1
        cleanup:
        User.deleteAll(User.list())
    ...
    void "test searchRegistrationRecords ok 1"() {
        ...
        controller.response.json == JSON.parse("{\"paging\": {\"total\": 1, \"limit\": 10, \"offset\":0}, results: [{\"id\": $registrationRecord.id, \"userUsername\": \"$user.username\", \"userId\": $user.id, \"userFingerprintId\": $user.fingerprintId,\"userFingerprintStatus\": \"$user.fingerprintStatus\", \"entryTime\":\"$dateParsed\", \"departureTime\": null, \"timeInSystem\": null}]}")
        User.count() == 1
        RegistrationRecord.count() == 1
        cleanup:
        User.deleteAll(User.list())
    ...
    void "test searchRegistrationRecords ok 2"() {
        ...
        controller.response.status == 200
        def dateParsed = sdf.format(user.dateCreated)
        controller.response.json == JSON.parse("{\"paging\": {\"total\": 1, \"limit\": 10, \"offset\":0}, results: [{\"id\": $registrationRecord.id, \"userUsername\": \"$user.username\", \"userId\": $user.id, \"userFingerprintId\": $user.fingerprintId, \"entryTime\":\"$dateParsed\", \"departureTime\": null, \"timeInSystem\": null, \"userFingerprintStatus\": \"$user.fingerprintStatus\"}]}")
        User.count() == 1
        RegistrationRecord.count() == 1
        cleanup:
        User.deleteAll(User.list())
    ...
    void "test searchRegistrationRecords ok 3"() {
        ...
        controller.response.status == 200
        def dateParsed = sdf.format(user.dateCreated)
        controller.response.json == JSON.parse("{\"paging\": {\"total\": 3, \"limit\": 2, \"offset\":1}, results: [{\"id\": $registrationRecord.id, \"userUsername\": \"$user.username\", \"userId\": $user.id, \"userFingerprintId\": $user.fingerprintId, \"entryTime\":\"$dateParsed\", \"departureTime\": null, \"timeInSystem\": null, \"userFingerprintStatus\": \"$user.fingerprintStatus\"}]}")
        User.count() == 3
    ...
    void "test searchRegistrationRecords ok 4"() {
        ...
        controller.response.json == JSON.parse("{\"paging\": {\"total\": 4, \"limit\": 2, \"offset\":1}, results: [{\"id\": $registrationRecord2.id, \"userUsername\": \"$user2.username\", \"userId\": $user2.id, \"userFingerprintId\": $user2.fingerprintId, \"entryTime\":\"$dateParsed2\", \"departureTime\": null, \"timeInSystem\": null, \"userFingerprintStatus\": \"$user2.fingerprintStatus\"}, {\"id\": $registrationRecord.id, \"userUsername\": \"$user.username\", \"userId\": $user.id, \"userFingerprintId\": $user.fingerprintId, \"entryTime\":\"$dateParsed\", \"departureTime\": null, \"timeInSystem\": null, \"userFingerprintStatus\": \"$user.fingerprintStatus\"}]}")
        User.count() == 4
    ...
    void "test searchRegistrationRecords ok 5"() {
        ...
        controller.response.json == JSON.parse("{\"paging\": {\"total\": 3, \"limit\": 2, \"offset\":0}, results: [{\"id\": $registrationRecord3.id, \"userUsername\": \"$user.username\", \"userId\": $user.id, \"userFingerprintId\": $user.fingerprintId, \"entryTime\":\"$dateParsed3\", \"departureTime\": null, \"timeInSystem\": null, \"userFingerprintStatus\": \"$user.fingerprintStatus\"}, {\"id\": $registrationRecord2.id, \"userUsername\": \"$user.username\", \"userId\": $user.id, \"userFingerprintId\": $user.fingerprintId, \"entryTime\":\"$dateParsed2\", \"departureTime\": null, \"timeInSystem\": null, \"userFingerprintStatus\": \"$user.fingerprintStatus\"}]}")
        User.count() == 2
        RegistrationRecord.count() == 4
        cleanup:
        User.deleteAll(User.list())
    ...
    void "test searchRegistrationRecords ok 6"() {
        ...
        def dateParsed2 = sdf.format(date2)
        controller.response.json == JSON.parse("{\"paging\": {\"total\": 2, \"limit\": 3, \"offset\":0}, results: [{\"id\": $registrationRecord2.id, \"userUsername\": \"$user.username\", \"userId\": $user.id, \"userFingerprintId\": $user.fingerprintId, \"entryTime\":\"$dateParsed2\", \"departureTime\": null, \"timeInSystem\": null, \"userFingerprintStatus\": \"$user.fingerprintStatus\"}, {\"id\": $registrationRecord.id, \"userUsername\": \"$user.username\", \"userId\": $user.id, \"userFingerprintId\": $user.fingerprintId, \"entryTime\":\"$dateParsed\", \"departureTime\": null, \"timeInSystem\": null, \"userFingerprintStatus\": \"$user.fingerprintStatus\"}]}")
        User.count() == 2
        RegistrationRecord.count() == 3
        cleanup:
        User.deleteAll(User.list())
