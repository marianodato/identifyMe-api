...
class UserControllerIntegrationSpec extends IntegrationSpec {
    ...
    void "test searchUser invalid sortBy"() {
        given:
        User user = new User(username: "Pepepe", name: "Pepe Pepe", dni: 1234567890, gender: "male", email: "pepepe@gmail.com", phoneNumber: "+54(11)1234-5678", isAdmin: true, fingerprintId: null, fingerprintStatus: "unenrolled", password: "100000:b9f0cdb48f6dd12694eaf1de44ab4a071da56765498abe8732dcf941966bf81ce839dfa4dae220e656760b8ff0d3a83103913a67bc9685083f445dda464449b2:51e7688ee57d721ad50622f50bb248ca55e34d01d5ee7168db050990585bfffcb49d3a9fa655cd3178ace50b668b201411a6bbdca18b8d4177307a33e842db6a", accessToken: "52f49b38931efb982422f593a0b1c261e357e943c81fbe4855d39e15f26db502553dd6423246480e537af51768ae27a45b3ffdea1ef8dbb61b1a5fac0a428fd4")
        def date = new Date()
        user.dateCreated = date
        ...
        controller.request.method = 'GET'
        controller.params.accessToken = "52f49b38931efb982422f593a0b1c261e357e943c81fbe4855d39e15f26db502553dd6423246480e537af51768ae27a45b3ffdea1ef8dbb61b1a5fac0a428fd4"
        controller.params.sortBy = "unknown"
        when:
        controller.searchUsers()
        then:
        thrown BadRequestException
    ...
    void "test searchUser invalid order"() {
        given:
        User user = new User(username: "Pepepe", name: "Pepe Pepe", dni: 1234567890, gender: "male", email: "pepepe@gmail.com", phoneNumber: "+54(11)1234-5678", isAdmin: true, fingerprintId: null, fingerprintStatus: "unenrolled", password: "100000:b9f0cdb48f6dd12694eaf1de44ab4a071da56765498abe8732dcf941966bf81ce839dfa4dae220e656760b8ff0d3a83103913a67bc9685083f445dda464449b2:51e7688ee57d721ad50622f50bb248ca55e34d01d5ee7168db050990585bfffcb49d3a9fa655cd3178ace50b668b201411a6bbdca18b8d4177307a33e842db6a", accessToken: "52f49b38931efb982422f593a0b1c261e357e943c81fbe4855d39e15f26db502553dd6423246480e537af51768ae27a45b3ffdea1ef8dbb61b1a5fac0a428fd4")
        def date = new Date()
        user.dateCreated = date
        ...
        controller.request.method = 'GET'
        controller.params.accessToken = "52f49b38931efb982422f593a0b1c261e357e943c81fbe4855d39e15f26db502553dd6423246480e537af51768ae27a45b3ffdea1ef8dbb61b1a5fac0a428fd4"
        controller.params.order = "unknown"
        when:
        controller.searchUsers()
        then:
        thrown BadRequestException
    ...
    void "test searchUser ok 4 sort by phoneNumber"() {
        given:
        User user = new User(username: "Pepepe", name: "Pepe Pepe", dni: 1234567890, gender: "male", email: "pepepe@gmail.com", phoneNumber: "+54(11)1234-5678", isAdmin: true, fingerprintId: null, fingerprintStatus: "unenrolled", password: "100000:b9f0cdb48f6dd12694eaf1de44ab4a071da56765498abe8732dcf941966bf81ce839dfa4dae220e656760b8ff0d3a83103913a67bc9685083f445dda464449b2:51e7688ee57d721ad50622f50bb248ca55e34d01d5ee7168db050990585bfffcb49d3a9fa655cd3178ace50b668b201411a6bbdca18b8d4177307a33e842db6a", accessToken: "52f49b38931efb982422f593a0b1c261e357e943c81fbe4855d39e15f26db502553dd6423246480e537af51768ae27a45b3ffdea1ef8dbb61b1a5fac0a428fd4")
        def date = new Date()
        user.dateCreated = date
        ...
        controller.params.offset = 1
        controller.params.limit = 2
        controller.params.sortBy = "phoneNumber"
        when:
        controller.searchUsers()
        then:
        controller.response.status == 200
    ...
    void "test searchUser ok 5"() {
        ...
        controller.params.offset = 1
        controller.params.limit = 2
        controller.params.disablePaging = false
        when:
        controller.searchUsers()
        then:
        controller.response.status == 200
    ...
    void "test searchUser ok 6"() {
        ...
        controller.params.offset = 1
        controller.params.limit = 2
        controller.params.disablePaging = true
        when:
        controller.searchUsers()
        then:
        controller.response.status == 200
        def dateParsed = sdf.format(user.dateCreated)
        def dateParsed2 = sdf.format(user2.dateCreated)
        def dateParsed3 = sdf.format(user3.dateCreated)
        def dateParsed4 = sdf.format(user4.dateCreated)
        controller.response.json == JSON.parse("{\"paging\": {\"total\": 4, \"limit\": 4, \"offset\":0}, results: [{\"id\": $user2.id, \"username\": \"Papapa\", \"name\": \"Papa Papa\", \"dni\": 1234567891, \"gender\":\"male\", \"email\": \"papapa@gmail.com\", \"phoneNumber\": \"+54(11)1234-5679\", \"dateCreated\": \"$dateParsed2\", \"fingerprintId\": 1, \"fingerprintStatus\": \"pending\", \"isAdmin\": false, \"lastUpdated\": \"$dateParsed2\"}, {\"id\": $user.id, \"username\": \"Pepepe\", \"name\": \"Pepe Pepe\", \"dni\": 1234567890, \"gender\":\"male\", \"email\": \"pepepe@gmail.com\", \"phoneNumber\": \"+54(11)1234-5678\", \"dateCreated\": \"$dateParsed\", \"fingerprintId\": null, \"fingerprintStatus\": \"unenrolled\", \"isAdmin\": true, \"lastUpdated\": \"$dateParsed\"}, {\"id\": $user3.id, \"username\": \"Pipipi\", \"name\": \"Pipi Pipi\", \"dni\": 1234567892, \"gender\":\"male\", \"email\": \"pipipi@gmail.com\", \"phoneNumber\": \"+54(11)1234-5670\", \"dateCreated\": \"$dateParsed3\", \"fingerprintId\": null, \"fingerprintStatus\": \"unenrolled\", \"isAdmin\": false, \"lastUpdated\": \"$dateParsed3\"},{\"id\": $user4.id, \"username\": \"Popopo\", \"name\": \"Popo Popo\", \"dni\": 1234567893, \"gender\":\"male\", \"email\": \"popopo@gmail.com\", \"phoneNumber\": \"+54(11)1234-5671\", \"dateCreated\": \"$dateParsed4\", \"fingerprintId\": null, \"fingerprintStatus\": \"unenrolled\", \"isAdmin\": false, \"lastUpdated\": \"$dateParsed4\"}]}")
        User.count() == 4
        cleanup:
        User.deleteAll(User.list())
    }
