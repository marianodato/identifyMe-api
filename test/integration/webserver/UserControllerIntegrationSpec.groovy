...
class UserControllerIntegrationSpec extends IntegrationSpec {
    ...
    void "test getUser cannot authenticate 1"() {
        given:
    ...
    void "test getUser cannot authenticate 2"() {
        given:
        controller.request.method = 'GET'
        controller.params.accessToken = "accessToken"
        when:
    ...
    void "test getUser ok"() {
        ...
        controller.response.json == JSON.parse("{\"id\": $user.id, \"username\": \"Pepepe\", \"name\": \"Pepe Pepe\", \"dni\": 1234567890, \"gender\":\"male\", \"email\": \"pepepe@gmail.com\", \"phoneNumber\": \"+54(11)1234-5678\", \"dateCreated\": \"$dateParsed\", \"fingerprintId\": null, \"fingerprintStatus\": \"unenrolled\", \"isAdmin\": false}")
        User.count() == 1
        cleanup:
        User.deleteAll(User.list())
    }
